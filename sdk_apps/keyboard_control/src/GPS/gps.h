...
#define TOLERANCE 15	// distance max that new position of target can be from its average position
...
int initialisation_gps(struct gps_coordinate *depart,struct gps_coordinate *dest, struct gps_coordinate *error_gps);
